...
(this, (function (exports) {
        ...
        function decode$1(e) {
			//console.log(Base64.encode(OBFUSCATING_BASE_64_PREFIX))
			  ...
			  const binaryString = window.atob(e.replace(OBFUSCATING_BASE_64_PREFIX, ""));
			  const bytes = new Uint8Array(binaryString.length);
			  for (let i = 0; i < binaryString.length; i++) {
				bytes[i] = binaryString.charCodeAt(i);
			  }
			  let atobStr = new TextDecoder().decode(bytes);

			return JSON.parse(decodeURIComponent(escape(atobStr)))
